...
from apps.baseinform.models import  Athlete, Action ,Joint
...
class Motion_data(models.Model):
    ...
    rightleg_pos_x = models.FloatField(verbose_name=u'右膝x轴坐标')#sdsdsds
...
class Curve_model(models.Model):
    ...
    # athlete = models.ForeignKey(Athlete, verbose_name=u"运动员")
    action = models.ForeignKey(Action, verbose_name=u"击球动作")
    joint = models.ForeignKey(Joint, verbose_name=u"人体关节")
    # testid = models.IntegerField(verbose_name=u"测试序号")
    # testdate = models.DateTimeField(verbose_name=u"测试日期",null=True,blank=True)
    frameno = models.IntegerField(verbose_name=u"帧编号")
    pos_x = models.FloatField(verbose_name=u'关节x方向坐标',null=True,blank=True)
    pos_y = models.FloatField(verbose_name=u'关节y方向坐标',null=True,blank=True)
    pos_z = models.FloatField(verbose_name=u'关节z方向坐标',null=True,blank=True)
    rot_x = models.FloatField(verbose_name=u'关节x方向角度',null=True,blank=True)
    rot_y = models.FloatField(verbose_name=u'关节y方向角度',null=True,blank=True)
    rot_z = models.FloatField(verbose_name=u'关节z方向角度',null=True,blank=True)
