...
class Coach(models.Model):
    coach_id = models.IntegerField(verbose_name=u"教练员ID",primary_key=True)
...
class Athlete(models.Model):
    athlete_id = models.IntegerField(verbose_name=u"运动员ID",primary_key=True)
    name = models.CharField(max_length=20, verbose_name=u"姓名")
...
class Action(models.Model):
    action_id = models.IntegerField(verbose_name=u"动作ID",primary_key=True)
...
class Joint(models.Model):
    joint_id = models.IntegerField(verbose_name=u"关节ID",primary_key=True)
